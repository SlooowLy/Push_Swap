...
void		swap_5(t_stack **a_head, t_stack **b_head, int swap, int o);
void		swap_8(t_stack **a_head, t_stack **b_head, int swap, int o);
void		swap_4(t_stack **a_head, t_stack **b_head, int swap, int o);
void		swap_3(t_stack **a_head, t_stack **b_head, int swap, int o);
void		swap_7(t_stack **a_head, t_stack **b_head, int swap, int o);
void		swap_6(t_stack **a_head, t_stack **b_head, int swap, int o);
void		swap_2(t_stack **a_head, t_stack **b_head, int swap, int o);
void		swap(t_stack **a_head, t_stack **b_head, int swap, int o);
