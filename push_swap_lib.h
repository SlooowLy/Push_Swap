...
void	push_to_b(t_stack **a_head, t_stack **b_head, int *operations);
...
void	sort_from_b_to_a(t_stack **a_head, t_stack **b_head, int *operations);
...
void	norm_function(char **av, int ac, t_stack *a_head, t_stack *b_head);
