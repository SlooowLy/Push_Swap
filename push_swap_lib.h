...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/06 10:50:40 by aaitoual          #+#    #+#             */
/*   Updated: 2022/03/06 10:50:41 by aaitoual         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			sort_from_b_to_a(t_stack **a_head, t_stack **b_head, int o);
t_stack		*whos_first(t_stack *a_head, t_stack *b_head, t_op *op, int o);
int			swap_b_a(t_stack **a_head, t_stack **b, t_stack *f, t_op *op);
int			check_b_a(t_stack *a_head, t_stack *b, t_stack *f, int min);
...
void		get_default(t_25_line_2 *t, t_op *op, t_stack *a, t_stack *b);
